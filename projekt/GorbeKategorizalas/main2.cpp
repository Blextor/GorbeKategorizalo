...
void main2( SDL_Window &window, SDL_Renderer &renderer){
    ...
    */
    ...
    t=clock();
    Nap nap(2023,10,14);
    { /// sikertelen a nap megtalálása
    cout<<true<<alma.getNap(nap,nap.datum)<<endl;
    nap = Nap(2023,10,15);
    cout<<true<<alma.getNap(nap,nap.datum)<<endl;
    }
    nap = Nap(2023,10,11); /// sikeres a nap megtalálása
    float ertek = 0;
    cout<<true<<alma.getNap(nap,nap.datum)<<endl;
    Nap mentettNap = nap; /// sokszoros
    cout<<nap.datum.year<<" "<<nap.datum.month<<" "<<nap.datum.day<<endl;
    cout<<alma.getNapOdebb(nap,nap,3)<<endl; /// sikerül- e túlindexelni
    alma.getMin(ertek,nap,true);
    cout<<"Ertek: "<<ertek<<endl;
    cout<<nap.datum.year<<" "<<nap.datum.month<<" "<<nap.datum.day<<endl;
    cout<<alma.getNapOdebb(nap,nap,-10000)<<endl; /// sikerül- e alulindexelni
    cout<<nap.datum.year<<" "<<nap.datum.month<<" "<<nap.datum.day<<endl;
    cout<<alma.getNapOdebb(nap,nap,2)<<endl; /// sikerül-e előrébb menni
    alma.getMin(ertek,nap,true);
    cout<<"Ertek: "<<ertek<<endl;
    ...
    cout<<"Ertek: "<<ertek<<endl;
    cout<<nap.datum.year<<" "<<nap.datum.month<<" "<<nap.datum.day<<endl;
    cout<<alma.getNapOdebb(nap,nap,-4)<<endl; /// sikerül-e hátrébb menni
    cout<<nap.datum.year<<" "<<nap.datum.month<<" "<<nap.datum.day<<endl;
